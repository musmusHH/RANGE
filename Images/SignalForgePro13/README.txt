...
UseOption13SapphireBitmapSkin=true enables the complete Option 13 layout. Dynamic labels and values are overlaid with native OBJ_LABEL objects. The Signal Module includes a live vertical 0-100 score meter and three runtime-generated neon circular percentage gauges for RSI, MACD and Signal Quality. Their illuminated arcs are rebuilt as the percentages change; they are not fixed painted effects. The Active Position module also shows live 0-100 normalized closed-bar readings for all eleven signal indicators: SMA, RSI, MACD, Supertrend, Stochastic, Bollinger, EMA, AO, SAR, CCI and ADX. Set the option false to use the responsive native-object fallback UI.